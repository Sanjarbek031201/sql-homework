create database lesson_9homework
use lesson_9homework
...
FROM 
    Products
JOIN 
    Suppliers ON Products.SupplierName= Suppliers.SupplierName
WHERE 
...
SELECT 
    ...
    (Orders.Quantity * Products.ProductPrice) AS ExpectedAmount
FROM 
    Payments
JOIN 
...
WHERE 
    Payments.Amount <> (Orders.Quantity * Products.ProductPrice);
