...
FROM Products_Discounted
WHERE Price > 100;
--4.Write a query to select all Customers whose ProductName start with 'A' using the LIKE operator
SELECT *
FROM Products_Discounted
...
--17.Write a query that filters the Products table for ProductName values containing the letter 'e' using LIKE.SELECT *
SELECT *
FROM Products
